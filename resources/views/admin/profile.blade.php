...
<div class="max-w-3xl bg-white rounded-2xl shadow-sm p-8 border border-slate-200">
    <div class="mb-6">
        <p class="text-cyan-600 font-semibold uppercase tracking-[0.3em] text-sm">Admin Profile</p>
        <h1 class="text-3xl font-bold mt-2">Update your administrator profile</h1>
    </div>
